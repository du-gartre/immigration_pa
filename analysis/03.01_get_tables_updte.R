...
df_cchs_1718_prep$sense_belong <- relevel(df_cchs_1718_prep$sense_belong, ref = "weak")
levels(df_cchs_1718_prep$sense_belong)

# # Add NA as a category
...
df_cchs_1718_prep_2 <- df_cchs_1718_prep


as.numeric(df_cchs_1718_prep_2$immigrant_new)



model_int <- glm(formula = disorder ~ immigrant_new*PA,
                 data = df_cchs_1718_prep_2,
                 family = binomial(link = "logit"))

summary(model_int)

interactionR(model_int,
             exposure_names = c("immigrant_new", "PA"),
...
dim(df_cchs_1718_prep)

df_cchs_1718_prep$disorder
df_cchs_1718_prep$immigrant
df_cchs_1718_prep$immigrant_new
df_cchs_1718_prep$PA
df_cchs_1718_prep$age_cat
df_cchs_1718_prep$sex_cat
df_cchs_1718_prep$sense_belong
df_cchs_1718_prep$household_inc_cat




model_1 <- glm(formula = disorder ~ PA + sex_cat + age_cat + sense_belong + household_inc_cat,
               data = df_cchs_1718_prep,
               family = binomial())
...
model_2 <- glm(formula = disorder ~ immigrant_new*PA + sex_cat + age_cat + sense_belong + household_inc_cat,
               data = df_cchs_1718_prep,
               family = binomial())

summary(model_2)
questionr::odds.ratio(model_2)
